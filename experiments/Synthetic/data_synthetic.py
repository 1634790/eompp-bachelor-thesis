...
hypergraphs on the *same* vertex set:
  ...
  * H_small (label 1, class "small") : hyperedges = all 2-subsets of
                                       the cliques C_i.
...
# --------------------------------------------------------------------------
def cliques_to_hypergraphs(cliques):
...
# Full dataset.
# --------------------------------------------------------------------------
def make_dataset(n_base, seed=0, feature_mode="constant", feat_dim=16,
    ...
    for bid in range(n_base):
        ...
        big, small = cliques_to_hypergraphs(cliques)
...
if __name__ == "__main__":
    ex = make_dataset(n_base=20, seed=0)
